...
namespace RgenLib.TaggedSegment {
    public partial class Manager<TRenderer> where TRenderer : TaggedCodeRenderer, new() {
        ...
        public abstract class Tag {
            ...
            public GeneratorOptionAttribute OptionAttribute { get; set; }

            public TAttr GetOptionAttribute<TAttr>() where TAttr : GeneratorOptionAttribute
            {
                return (TAttr) OptionAttribute;
            }
